"""
Sensor Monitor V3.3 - Universal CO2 + ENV Monitor
Author: Zell
Date: 2026/06/15
...
WINDOW_TITLE = "Sensor Monitor V3.3 — CO2 + ENV (S3/C3)"
...
def fetch_sea_level_pressure(lat=LOCATION_LAT, lon=LOCATION_LON):
    ...
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "SensorMonitor/3.3"})
...
class SensorMonitorV3:
    ...
    def _show_about(self):
        ...
        ttk.Label(frame, text="Sensor Monitor V3.3", font=("Segoe UI", 13, "bold")).pack(pady=(0, 8))
        info_lines = [
