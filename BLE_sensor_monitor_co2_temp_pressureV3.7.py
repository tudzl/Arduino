"""
Sensor Monitor V3.7 - Universal CO2 + ENV Monitor
Author: Zell
Date: 2026/06/16
...
WINDOW_TITLE = "Sensor Monitor V3.7 — CO2 + ENV (S3/C3)"
...
class SensorMonitorV3:
    ...
    def _show_about(self):
        ...
        ttk.Label(frame, text="Sensor Monitor V3.7", font=("Segoe UI", 13, "bold")).pack(pady=(0, 8))
        info_lines = [
